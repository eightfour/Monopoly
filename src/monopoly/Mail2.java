...
import javax.mail.internet.MimeMultipart;
		...
		public class Mail2 extends Thread {
			 ...
			 */
		public Mail2(String an, String betreff, String text, 
			...
			p.put("mail.smtp.user","GruppeA116@gmx.de");
			p.put("mail.smtp.password","GruppeA116");
			p.put("mail.smtp.socketFactory.port","465");
			p.put("mail.smtp.socketFactory.class","javax.net.ssl.SSLSocketFactory");
			p.put("mail.smtp.auth","true");
			p.put("mail.smtp.port","465");
			p.put("von","GruppeA116@gmx.de");
			p.put("an",an);
		...
		public void run(){
			try{
				//TODO System.out.println("Start Mailing an "+p.getProperty("an"));
